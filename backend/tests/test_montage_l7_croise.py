...
check("x1_SVM_ACTIONS_du_bundle_x1_48_actions_ids_uniques_et_les_ids_du_preset_en_font_partie",
      BUN.count("var SVM_ACTIONS=[") == 1 and len(IDS_ACT) == 48 and len(set(IDS_ACT)) == 48 and len(COMBOS_ACT) == 48
...
check("x1_etat_vide_le_meme_compteur_ne_trouve_pas_un_id_invente_temoin_blade_trouve",
      len(IDS_ACT) == 48 and "blade" in IDS_ACT and "zzz_pas_une_action" not in IDS_ACT and COMBOS_ACT.get("blade") == "Alt+C", COMBOS_ACT.get("blade"))
...
check("x1_temoin_les_juges_du_bundle_canonisent_ctrl_t_en_Ctrl_T_la_disent_reservee_refusent_Zork_Q_et_laissent_Alt_T_48_actions",
      ...
      and K["temoin"].get("zzz") == "" and K["temoin"].get("alt_t") == "" and K["temoin"].get("n") == 48 == len(IDS_ACT), _kwhy or K.get("temoin"))
